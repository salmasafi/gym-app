...
import 'package:gym_app/features/Screens/set_up/presentation/screens_Setup/sc_405.dart';
        ...
        children: [
          ...
          CustomButton(
            ...
            onPress: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => Sc405(sex: widget. sex, age: widget. age, weight: weight.toDouble())),
              );
            },
            width: 178,
            height: 44,
